...
#define _____________Base_Bottom_Center_6k_________ _______, RS_ESC, LW_ENT,  LW_SPC,  RS_BSP, _______
...
#define _____________SYM_Home_Core_10k_____________ KC_LBRC, LAB_CLS, KC_LPRN, KC_LCBR, QK_AREP, EQ_DEQ, OC_BRACES,  OC_PARENS, RAB_DRW, OC_BRKETS
