...
#define _____________SYM_Home_Sides_12k____________ O_LCTL, _____________SYM_Home_Core_10k_____________, O_RCTL
#define _____________SYM_1Dn_Sides_L_6k____________ O_LSFT, _______,  O_LALT, O_LCTL, _______, _______
#define _____________SYM_1Dn_Sides_R_6k____________                                                     _______, TG_MCR,  O_RCTL, O_RALT, _______, O_RSFT
...
#define _____________NAV_1Dn_Sides_L_6k____________ KC_DEL,  L_NAV,   KC_LCTL, KC_DOWN, KC_UP,   _______
...
#define _____________MCR_2Up_Sides_12k_____________ M_CSE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
#define _____________MCR_1Up_Sides_12k_____________ M_CSE, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, KC_PSCR, _______, _______, M_LOK,   _______
#define _____________MCR_Home_Sides_12k____________ M_CSE, _______, _______, _______, M_CAD,   _______, _______, _______, _______, _______, KC_SLEP, _______
#define _____________MCR_1Dn_Sides_L_6k____________ _______, _______, _______, _______, _______, _______
