...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | `   | Q | W | E | R | T | Y | U | I | O | P |  \   |
   * |----------------------------------------------------|
   * | EsCt | A | S | D | F | G | H | J | K | L | ;| AEnt |
   * |----------------------------------------------------|
   * | Shift | Z | X | C | V | B | N | M | , | . | / | SB |
   * |----------------------------------------------------|
   * |Ctrl|Alt |Gui |    Space/Nav     |FMnu|Fn3 |Mnu|Ctrl|
   * `----------------------------------------------------'
   */
  [0] = LAYOUT_60_ansi(
	       _____,   _____,   _____,   _____,  _____,  _____,  _____,   _____, _____,   _____,  _____,   _____,   _____,   _____,   \
	       KC_GESC, KC_Q,    KC_W,    KC_E,   KC_R,   KC_T,   KC_Y,    KC_U,  KC_I,    KC_O,   KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, \
	       ...
	       KC_LCTL, KC_LALT, KC_LGUI, SP_NAV, FN_MNU, FN_MNU, KC_RALT, KC_RCTL
		   ),

  /* Keymap 1: Navigation, VIM
   * Parent: Default (Space)
   * Chldrn: None
   * ,-----------------------------------------------------------.
  ...
  [_NAV] = LAYOUT_60_ansi(
	       _____, _____, _____, _____, _____, _____, _____,   _____,   _____, _____,   _____,   _____,  _____,  _____, \
	       KC_1,  KC_2,  KC_3,  KC_4,  KC_5,  KC_6,  KC_7,    KC_8,    KC_9,  KC_0,    KC_MINS, KC_EQL, KC_INS, _____, \
