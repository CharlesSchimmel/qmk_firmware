...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |SftTab  | Z | X | C | V | B | N | M | , | . | / |  SftBsp  |
   * |-----------------------------------------------------------|
   * |Ctrl|Alt |Gui |       Space/Nav         |Func|Fn3 |Mnu|Ctrl|
   * `-----------------------------------------------------------'
   */
  [0] = LAYOUT_60_ansi(
	       ...
	       KC_LCTL, KC_LALT, KC_LGUI, SP_NAV, MO(_FUNC), FN_MNU, KC_APP, KC_RCTL
		   ),
  ...
  [_NAV] = LAYOUT_60_ansi(
	       _____, _____, _____, _____, _____, _____, _____,   _____,   _____, _____,   _____, _____,   _____,  _____,  \
	       _____, KC_1,  KC_2,  KC_3,  KC_4,  KC_5,  KC_6,    KC_7,    KC_8,  KC_9,    KC_0,  KC_MINS, KC_EQL, KC_INS, \
