...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FNC] = LAYOUT_60_ansi(
	       ...
	       _____,  M_LOK,   M_CAD,   _____, DF(_RAD), DF(_DEF), _____,   _____, _____,   _____,   KC_MPLY, KC_MPRV, KC_MNXT, _____,  \
  ...
  /* Keymap 4: "RAD" Layer - More ergonomic modifiers
   * ,-----------------------------------------------------------.
   * | ` | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 0 | - | = |   Bs  |
   * |-----------------------------------------------------------|
   * | LTab| Q | W | E | R | T | Y | U | I | O | P | [ | ] | \lt |
   * |-----------------------------------------------------------|
   * | ShTab | A | S | D | F | G | H | J | K | L | ; | ' | SfBsp |
   * |---------------------.-----------.-------------------------|
   * | EsCtl  | Z | X | C | V | B | N | M | , | . | / |  CtlEnt  |
   * |-----------------------------------------------------------|
   * |Ctrl|Alt |Gui |         SpNav           |Sym | Fn |Alt|Ctrl|
   * `-----------------------------------------------------------'
   */
  [_RAD] = LAYOUT_60_ansi(
	       KC_GESC, KC_1,    KC_2,    KC_3,   KC_4,    KC_5,    KC_6,    KC_7, KC_8,    KC_9,   KC_0,    KC_MINS, KC_EQL,  KC_BSPC, \
	       AL_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,    KC_Y,    KC_U, KC_I,    KC_O,   KC_P,    KC_LBRC, KC_RBRC, AL_BSLS, \
	       SH_TAB,  KC_A,    KC_S,    KC_D,   KC_F,    KC_G,    KC_H,    KC_J, KC_K,    KC_L,   KC_SCLN, KC_QUOT, SH_BSP,  \
	       CT_ESC,  KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,    KC_N,    KC_M, KC_COMM, KC_DOT, KC_SLSH, CT_ENT,  \
	       KC_LCTL, KC_LALT, KC_LGUI, SP_NAV, MNU_FNC, KC_RGUI, KC_RALT, KC_RCTL
		   ),
